...
Метод простой итерации является классическим итерационным методом решения систем линейных алгебраических уравнений. В отличие от прямых методов, итерационные методы позволяют получить приближенное решение с заданной точностью и хорошо подходят для распараллеливания, особенно для больших разреженных матриц.
